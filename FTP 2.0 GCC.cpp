...
namespace features {
    ...
    void tulisan_FTP() {
        goto_xy(20, 5);  printf("%c%c%c%c%c  %c  %c%c    %c  %c%c%c%c  ", $, $, $, $, $, $, $, $, $, $, $, $, $);
        goto_xy(20, 6);  printf("%c      %c  %c %c   %c  %c   %c ", $, $, $, $, $, $, $);
        goto_xy(20, 7);  printf("%c%c%c%c%c  %c  %c  %c  %c  %c    %c", $, $, $, $, $, $, $, $, $, $, $);
        goto_xy(20, 8);  printf("%c      %c  %c   %c %c  %c   %c ", $, $, $, $, $, $, $);
        goto_xy(20, 9);  printf("%c      %c  %c    %c%c  %c%c%c%c  ", $, $, $, $, $, $, $, $, $);
        goto_xy(20, 10); printf("                         ");
        goto_xy(20, 11); printf("  %c%c%c%c%c  %c   %c  %c%c%c%c%c    ", $, $, $, $, $, $, $, $, $, $, $, $);
        goto_xy(20, 12); printf("    %c    %c   %c  %c        ", $, $, $, $);
        goto_xy(20, 13); printf("    %c    %c%c%c%c%c  %c%c%c%c%c    ", $, $, $, $, $, $, $, $, $, $, $);
        goto_xy(20, 14); printf("    %c    %c   %c  %c        ", $, $, $, $);
        goto_xy(20, 15); printf("    %c    %c   %c  %c%c%c%c%c    ", $, $, $, $, $, $, $, $);
        goto_xy(20, 16); printf("                         ");
        goto_xy(20, 17); printf(" %c%c%c    %c%c%c%c%c%c  %c  %c%c%c   ", $, $, $, $, $, $, $, $, $, $, $, $, $);
        goto_xy(20, 18); printf(" %c  %c   %c    %c  %c  %c  %c  ", $, $, $, $, $, $, $);
        goto_xy(20, 19); printf(" %c   %c  %c    %c  %c  %c   %c ", $, $, $, $, $, $, $);
        goto_xy(20, 20); printf(" %c  %c   %c%c%c%c%c%c  %c  %c  %c  ", $, $, $, $, $, $, $, $, $, $, $);
        goto_xy(20, 21); printf(" %c%c%c    %c    %c  %c  %c%c%c   ", $, $, $, $, $, $, $, $, $);
        goto_xy(20, 22); printf(" %c      %c    %c  %c  %c  %c  ", $, $, $, $, $, $);
        goto_xy(20, 23); printf(" %c      %c    %c  %c  %c   %c ", $, $, $, $, $, $);
    }

    void tulisan_menang() {
        goto_xy(21, 8);  printf("%c   %c  %c%c%c%c%c%c  %c     %c", $, $, $, $, $, $, $, $, $, $);
        goto_xy(21, 9);  printf(" %c %c   %c    %c  %c     %c", $, $, $, $, $, $);
        goto_xy(21, 10); printf("  %c    %c    %c  %c     %c", $, $, $, $, $);
        goto_xy(21, 11); printf("  %c    %c    %c  %c     %c", $, $, $, $, $);
        goto_xy(21, 12); printf("  %c    %c    %c  %c     %c", $, $, $, $, $);
        goto_xy(21, 13); printf("  %c    %c%c%c%c%c%c  %c%c%c%c%c%c%c", $, $, $, $, $, $, $, $, $, $, $, $, $, $);
        goto_xy(21, 14); printf("                      ");
        goto_xy(21, 15); printf("%c   %c   %c  %c  %c%c     %c", $, $, $, $, $, $, $);
        goto_xy(21, 16); printf("%c   %c   %c  %c  %c %c    %c", $, $, $, $, $, $, $);
        goto_xy(21, 17); printf("%c   %c   %c  %c  %c  %c   %c", $, $, $, $, $, $, $);
        goto_xy(21, 18); printf("%c   %c   %c  %c  %c   %c  %c", $, $, $, $, $, $, $);
        goto_xy(21, 19); printf("%c   %c   %c  %c  %c    %c %c", $, $, $, $, $, $, $);
        goto_xy(21, 20); printf("%c%c%c%c%c%c%c%c%c  %c  %c     %c%c", $, $, $, $, $, $, $, $, $, $, $, $, $);
    }
}
...
public:
    ...
    void menu() {
        ...
        while (true) {
            ...
            // Label menu
            features::goto_xy(85, 8);  std::cout << "A. NEW GAME";
            features::goto_xy(90, 11); std::cout << "OR";
            features::goto_xy(85, 14); std::cout << "B. EXIT GAME";
            features::goto_xy(85, 19); std::cout << "Pilih (A/B)? : ";
            ...
            if (pilihan_menu == 'A' || pilihan_menu == 'a')
                ...
                features::goto_xy(82, 22); std::cout << "MASUKKAN DENGAN BENAR!";
    ...
    void game_play() {
        while (true) {
            ...
            features::goto_xy(73, 4);  std::cout << "SELEKTOR";
            cards[0].display_cards(71, 6);
		    features::goto_xy(100, 4); std::cout << "PROGRESS";
            cards[1].display_cards(98, 6);
            
            // Label keterangan
            features::goto_xy(71, 23); std::cout << "Keterangan: ";

            // Label Pilihan dan input user
            features::goto_xy(71, 16); std::cout << "Pilih 2 kartu yang ingin dibandingkan!";
            features::goto_xy(71, 18); std::cout << "Pilih 2 buah abjad dari SELEKTOR: ";
            features::goto_xy(71, 20); std::cout << "Abjad pertama\t: ";
            features::goto_xy(71, 21); std::cout << "Abjad kedua\t: ";
            features::goto_xy(90, 20); std::cin >> abjad1;
            std::cin.ignore();
            features::goto_xy(90, 21); std::cin >> abjad2;
            std::cin.ignore();
